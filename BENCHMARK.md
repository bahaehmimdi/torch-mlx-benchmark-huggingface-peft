# huggingface/peft — Benchmark torch-mlx sur Mac

**Statut : OK — LoRA sur GPT2**

**torch-mlx** est une reimplémentation de l'API PyTorch basée sur le moteur **MLX
d'Apple Silicon**. L'architecture de **huggingface/peft** a été testée de manière **non modifiée**.
